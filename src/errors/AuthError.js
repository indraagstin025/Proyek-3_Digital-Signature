...
class AuthError extends BaseError {
  ...
  static InvalidToken(message = "Token otentikasi tidak valid atau tidak dikenali.") {
    return new AuthError("INVALID_TOKEN", 401, message);
  }

  static SessionExpired(message = "Sesi Anda telah berakhir. Silakan login kembali.") {
    return new AuthError("SESSION_EXPIRED", 401, message);
  }

  static EmailNotVerified(message = "Silakan verifikasi email Anda terlebih dahulu.") {
    return new AuthError("EMAIL_NOT_VERIFIED", 403, message);
  }
