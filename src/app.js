...
const documentController = createDocumentController(documentService, signatureRepository, fileStorage);
const groupSignatureController = createGroupSignatureController(groupSignatureService, groupService);
